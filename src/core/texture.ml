...
let glock_bullet_txt_reverted = ref (Color (Gfx.color 0 0 0 0))
let player_txt = ref (Color (Gfx.color 0 0 0 0))
let player_txt_reverted = ref (Color (Gfx.color 0 0 0 0))
let rl_txt = ref (Color (Gfx.color 0 0 0 0))
let rl_rocket_txt = ref (Color (Gfx.color 0 0 0 0))
let rl_rocket_txt_reverted = ref (Color (Gfx.color 0 0 0 0))
let explosion_txt = ref (Color (Gfx.color 0 0 0 0))
let shotgun_txt = ref (Color (Gfx.color 0 0 0 0))
let shotgun_pelet_txt = ref (Color (Gfx.color 0 0 0 0))
let shotgun_pelet_txt_reverted = ref (Color (Gfx.color 0 0 0 0))
let laser_txt = ref (Color (Gfx.color 0 0 0 0))
let laser_laser_txt = ref (Color (Gfx.color 0 0 0 0))
let left_wall_txt = ref (Color (Gfx.color 0 0 0 0))
